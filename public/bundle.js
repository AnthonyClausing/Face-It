...
var _videoFeed = __webpack_require__(44);
    ...
    _createClass(Main, [{
        ...
        value: function componentDidMount() {
            ...
            if (navigator.mediaDevices) {
                navigator.mediaDevices.getUserMedia({ video: true, audio: true }).then(this.handleVideoSource).catch(console.log);
            }
        }
        ...
        value: function render() {
            var videoJsOptions = { //SRC WILL BE UNIQUE TO EACH PERSON IN THE ROOM.
                autoplay: true,
                controls: false,
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_videoFeed2.default, { videoOptions: videoJsOptions })
            );
        }
    }]);
...
var _motionSensing = __webpack_require__(47);
...
var blendCanvas = function (_Component) {
  _inherits(blendCanvas, _Component);

  function blendCanvas(props) {
    _classCallCheck(this, blendCanvas);

    var _this = _possibleConstructorReturn(this, (blendCanvas.__proto__ || Object.getPrototypeOf(blendCanvas)).call(this, props));
  ...
  _createClass(blendCanvas, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var blendedContext = this.blendedCanvas.getContext('2d');
      this.setState({ context: blendedContext });
      (0, _motionSensing.checkHotSpots)(blendedContext);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement('canvas', { id: 'blendCanvas', ref: function ref(blendedCanvas) {
          return _this2.blendedCanvas = blendedCanvas;
...
var videoCanvas = function (_Component) {
  _inherits(videoCanvas, _Component);

  function videoCanvas(props) {
    _classCallCheck(this, videoCanvas);

    var _this = _possibleConstructorReturn(this, (videoCanvas.__proto__ || Object.getPrototypeOf(videoCanvas)).call(this, props));

    _this.state = {
      video: "",
      context: {}
    };
    _this.handleFill = _this.handleFill.bind(_this);
    return _this;
  }

  _createClass(videoCanvas, [{
    key: 'handleFill',
    value: function handleFill() {
    ...
    key: 'componentDidMount',
    value: function componentDidMount() {
      var videoCC = this.videoCanvas.getContext('2d');
    ...
    value: function componentDidUpdate() {
      ...
      this.state.video.onplay = function () {
        _this2.state.context.drawImage(_this2.state.video, 0, 0, videoCanvas.width, videoCanvas.height);
        _this2.state.context.fillStyle = '#FFFFFF';
        _this2.state.context.fillRect(20, 20, videoCanvas.width, videoCanvas.height);
      };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement('canvas', { id: 'videoCanvas', ref: function ref(canvas) {
          return _this3.videoCanvas = canvas;
        }, height: '480px', width: '640px', onClick: this.handleFill });
    }
  }]);
...
var _videoCanvas = __webpack_require__(43);

var _videoCanvas2 = _interopRequireDefault(_videoCanvas);

var _blendCanvas = __webpack_require__(42);

var _blendCanvas2 = _interopRequireDefault(_blendCanvas);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('video', { ref: function ref(video) {
					...
					}, src: this.props.videoOptions.src, autoPlay: this.props.videoOptions.autoplay, className: 'player-videos' }),
				_react2.default.createElement(_videoCanvas2.default, { videoFeed: this.state.video }),
				_react2.default.createElement(_blendCanvas2.default, null)
			);
		}
	}]);
...
function connectToSite(roomTaken) {
    ...
    socket.on('roomTaken', function (msg) {
        console.log(msg);
        roomTaken(msg);
    });
...
module.exports = {
    connectToSite: connectToSite, joinRoom: joinRoom, newRoom: newRoom
};
...
exports.checkHotSpots = checkHotSpots;
...
function checkHotSpots(context) {
...
*/
var aa=__webpack_require__(2),m=__webpack_require__(21),A=__webpack_require__(8),B=__webpack_require__(4),ca=__webpack_require__(20),da=__webpack_require__(24),ea=__webpack_require__(25),ha=__webpack_require__(22),ia=__webpack_require__(23),C=__webpack_require__(7);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(8),n=__webpack_require__(7),p=__webpack_require__(4);
