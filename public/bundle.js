...
var _videoFeed = __webpack_require__(43);

var _videoFeed2 = _interopRequireDefault(_videoFeed);

var _clientSocket = __webpack_require__(42);
...
var Main = function (_Component) {
    ...
    function Main() {
        ...
        _this.rommTaken = _this.roomTaken.bind(_this);
        return _this;
    }
    ...
    _createClass(Main, [{
        ...
        value: function componentDidMount() {
            this.setState({ socket: (0, _clientSocket.connectToSite)(this.roomTaken) });
        ...
        value: function handleNewRoom(event) {
            ...
            (0, _clientSocket.newRoom)(this.state.socket, event.target.newRoom.value);
        ...
        value: function handleJoinRoom(event) {
            event.preventDefault();
            (0, _clientSocket.joinRoom)(this.state.socket, event.target.joinRoom.value);
