...
var _videoFeed = __webpack_require__(42);

var _videoFeed2 = _interopRequireDefault(_videoFeed);

var _rtc = __webpack_require__(44);
...
var Main = function (_Component) {
    ...
    function Main() {
        ...
        _this.handleNewRoom = _this.handleNewRoom.bind(_this);
        _this.roomTaken = _this.roomTaken.bind(_this);
        _this.createPeerConnection = _rtc.createPeerConnection.bind(_this);
        _this.doAnswer = _rtc.doAnswer.bind(_this);
        return _this;
    }
    ...
    _createClass(Main, [{
        ...
        value: function componentDidMount() {
            ...
            socket.on('someoneJoinedTheRoom', function () {
                console.log('someone joined');
                _this2.isInitiator = true;
                _this2.createPeerConnection(_this2.state, socket);
                console.log('pc after someone joined:', _this2.pc);
            });
        ...
        key: 'roomTaken',
        value: function roomTaken(msg) {
            document.getElementById('roomTaken').innerHTML = msg;
        }
    }, {
        key: 'handleNewRoom',
        value: function handleNewRoom(event) {
        ...
        key: 'handleJoinRoom',
        value: function handleJoinRoom(event) {
            event.preventDefault();
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Create Room:',
                        _react2.default.createElement('input', { type: 'text', name: 'newRoom' })
                    ),
                    _react2.default.createElement('input', { type: 'submit', name: 'submitNew' })
                ),
                _react2.default.createElement(
                    'form',
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Join Room:',
                        _react2.default.createElement('input', { type: 'text', name: 'joinRoom' })
                    ),
                    _react2.default.createElement(
                        'label',
                        null,
                    ...
                    _react2.default.createElement('input', { type: 'submit', name: 'submitJoin' })
                ),
...
var VideoFeed = function (_Component) {
    ...
    function VideoFeed() {
        ...
        return _possibleConstructorReturn(this, (VideoFeed.__proto__ || Object.getPrototypeOf(VideoFeed)).call(this));
    }
...
function createPeerConnection(state, socket) {
    ...
    if (this.isInitiator) {
        this.pc.createOffer().then(function (offer) {
            ...
            console.log('localdes:', _this.pc.localDescription);
            socket.emit('signal', _this.pc.localDescription);
        });
    } else {
...
function doAnswer(socket) {
    ...
    this.pc.createAnswer().then(function (answer) {
        ...
        socket.emit('signal', _this2.pc.localDescription);
    });
}
...
module.exports = {
    createPeerConnection: createPeerConnection, doAnswer: doAnswer, handleIceCandidate: handleIceCandidate, handleRemoteStreamAdded: handleRemoteStreamAdded, handleRemoteStreamRemoved: handleRemoteStreamRemoved
};
...
*/
var aa=__webpack_require__(4),m=__webpack_require__(21),A=__webpack_require__(8),B=__webpack_require__(3),ca=__webpack_require__(20),da=__webpack_require__(24),ea=__webpack_require__(25),ha=__webpack_require__(22),ia=__webpack_require__(23),C=__webpack_require__(7);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(8),n=__webpack_require__(7),p=__webpack_require__(3);
